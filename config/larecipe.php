...
return [
    ...
    */
    ...
    'repository'   => [
        'provider' => 'github',
        'url'      => 'https://github.com/check-in-dog/docs-fr.checkindog.com'
    ],
    ...
    */
    ...
    'seo'                 => [
        'author'          => 'Check-in DOG',
        'description'     => 'Check-in DOG est un logiciel conçu pour gérer un salon de toilettage : gestion des clients et de leurs animaux, rendez-vous et rappels automatiques, facturation et outils marketing innovants. Voici la documentation en langue française.',
        'keywords'        => 'checkindog, logiciel, gestion, toilettage',
        'og'              => [
            'title'       => 'Check-in DOG Gestion Salon de Toilettage - Documentation en Français',
            'type'        => 'article',
            'url'         => '',
            'image'       => '',
            'description' => '',
